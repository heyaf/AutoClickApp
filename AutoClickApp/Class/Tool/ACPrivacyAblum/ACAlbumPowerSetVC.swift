...
class ACAlbumPowerSetVC: UIViewController {
    ...
    func setupUI() {
        ...
        cancleBtn.setTitleColor(UIColor(hex: "333333"), for: .normal)
        ...
        Label1.textColor = UIColor(hex: "333333")
        Label1.numberOfLines = 2
        Label1.textAlignment = .center
        Label1.text = KLanguage(key: "Photos")
        view.addSubview(Label1)
        
        let setBtn = UIButton(type: .custom)
        setBtn.frame = CGRect(x: KScreenWidth / 2 - 40 , y: Label1.bottom, width: 80, height: 20)
